...
/* getLocalIPs()
   ...
   The phone and PC must be on the same Wi-Fi network; the relevant address is
...
function startServer(cb) {
    server.listen(PORT, '0.0.0.0', () => {
        /* Build the startup banner. LAN IPs (excluding loopback) are listed
           ...
           app or browser when connecting from another device on the same Wi-Fi. */
        ...
        console.log('║                                              ║');
        console.log(line('Android app WebSocket (same Wi-Fi):'));
