...
function createWindow() {
    mainWindow = new BrowserWindow({
        ...
        minWidth: 900,
        minHeight: 600,
        backgroundColor: '#050608', // prevents white flash before the page loads
        show: false,                // hidden until 'ready-to-show' fires (avoids flicker)
        autoHideMenuBar: true,
        title: 'Mobile Magnetometer',
        webPreferences: {
            nodeIntegration: false,  // keep renderer isolated — no Node.js in the page JS
            contextIsolation: true,  // belt-and-suspenders security for the WebView
        },
    });
